...
public class Manager extends Employee implements Serializable {
    ...
    public void addCourseForRegistration(Course course) {
        ...
        System.out.println(
                "Course added for registration: "
                        + course.getName()
        );
    }

    public void assignCourseToTeacher(Course course,
                                      Teacher teacher) {
    ...
    public void addPendingEnrollment(Enrollment enrollment) {
